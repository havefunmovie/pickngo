...
class To extends Component
{
    ...
    protected array $rules = [
        ...
        'to.to-address2'      => 'sometimes|string',
        'to.to-country'       => 'required',
        'to.to-postal'        => 'required',
        'to.to-city'          => 'required',
        'to.to-province'      => 'required',
        'to.to-attention'     => 'sometimes|',
        'to.to-phone'         => 'required|numeric',
        'to.to-email'         => 'sometimes|email',
        'to.to-instruction'   => 'sometimes|string',
    ];
    ...
    public function render()
    {
        ...
        return view('livewire.admin.agent.parcel.details.to', compact('validated','countries'));
    }
