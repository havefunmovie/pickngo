    ...
    public function getLabel($data, $service, $label) {
        ...
        try {
            ...
            $order = OrderParcel::create([
                ...
                'dimen_type' => $data['package']['dimen-type'],
...
//            '$' . number_format((float)($item->TotalCharges->MonetaryValue) * (($this->service['service_percentage']) / 100), 2, '.', '')
            Transactions::create([
    ...
    {
        return view('livewire.admin.agent.parcel.details.get-label');
    }
}
