...
class GetLabel extends Component
{
    ...
    public function getLabel($data) {
        try {
            ...
            Session::put('image', $faxing->id);;
            Session::put('label-type', 'faxing');
            ...
            $this->data = $data;
            $this->data['tracking_code'] = $faxing->tracking_code;
        } catch (Exception $e) {
            dd($e);
        }
    }
    ...
    {
        return view('livewire.admin.agent.faxing.details.get-label');
    }
}
