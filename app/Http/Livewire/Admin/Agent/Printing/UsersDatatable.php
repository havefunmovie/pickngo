...
class UsersDatatable extends LivewireDatatable
{
    ...
    public function columns()
    {
        return [
            ...
            Column::callback(['id'], function ($id) {
                return view('livewire.admin.agent.printing.users-table-actions', ['id' => $id]);
            })
        ];
    }
    ...
    public function AddNew($id) {
        session()->flash('newPrintingForExistingUser', $id);
        return redirect()->route('agent.printing.create');
    }
