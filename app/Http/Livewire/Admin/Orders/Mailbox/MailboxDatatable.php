...
class MailboxDatatable extends LivewireDatatable
{
    ...
    {
        return [
            NumberColumn::name('userMailbox.customer_1')->label('id')->searchable(),
            ...
            NumberColumn::name('mailbox_types.price')->label('Price')->searchable(),
    ...
    public function builder()
    {
        ...
        $boxes = $boxes->with('boxType')->with('user')->where('is_temp', 0)->where('level' , null);
        return $boxes;
    }
}