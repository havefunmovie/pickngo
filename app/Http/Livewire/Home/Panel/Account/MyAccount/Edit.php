...
class Edit extends Component
{
    ...
    public function mount($id) {
        $this->method = PaymentInfo::where('id', $id)->where('user_id', auth()->user()->id)->get()->toArray();
        $this->method = array_shift($this->method);
    ...
    public function edit() {
        ...
        PaymentInfo::where('id', $this->method['id'])->update([
    ...
    public function render()
    {
        ...
        return view('livewire.home.panel.account.my-account.edit', compact('countries', 'validated'));
    }
}
