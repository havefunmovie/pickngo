...
{
    public $validated, $payment, $data, $error, $mServiceSummary;
...
//        $this->dispatchBrowserEvent('activity-detail', ltrim($mServiceSummary['negotiated_charge'], '$'));
    ...
    public function getLabel() {
        ...
        $result = $paypal->createNewOrder($this->mServiceSummary['currency'], round(ltrim($this->mServiceSummary['negotiated_charge'], '$'),2), 'home.services.parcel');
...
//        }
    ...
    public function render()
    {
        ...
        return view('livewire.home.panel.services.parcel-content.parcel.payment', compact('countries', 'validated'));
    }
}
