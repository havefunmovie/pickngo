...
class Envelop extends Component
{
    ...
    protected array $rules = [
        ...
        'envelop.length'      => 'required|numeric',
        'envelop.width'       => 'required|numeric',
        'envelop.height'      => 'required|numeric',
    ...
    public function render()
    {
        ...
        return view('livewire.home.sections.getQuotes.envelop',compact('recommends','upsErrors','countries'));
    }
