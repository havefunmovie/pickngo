...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function make($name, $title, $steps, $options = [])
        {
                        /** @var \Ycs77\LaravelWizard\WizardFactory $instance */
                        return $instance->make($name, $title, $steps, $options);
        }
...
namespace  { 
            ...
            class Wizard extends \Ycs77\LaravelWizard\Facades\Wizard {}
