<div>
    <div class="table-responsive">
        <table class="table table-hover table-danger mt-3" width="100%">
            ...
            @if($services)
                @foreach($services as $row)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.settings.scanning.edit', $row['id']) }}" class="btn btn-sm btn-outline-danger py-0">Edit</a>
                        </td>
                    </tr>
                @endforeach
            @else
