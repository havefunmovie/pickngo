                ...
                <div class="d-flex align-items-center">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Edit/Create API Settings</li>
                        </ol>
                    </nav>
                </div>
            </div>
                            ...
                            <div class="col-sm-12">
                                <form wire:submit.prevent="edit" class="needs-validation">
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="account_number">User</label>
                                                <select class="form-control custom-select {{ $errors->has('info.agent_id') ? 'is-invalid' : '' }} {{ isset($validated) && array_key_exists('info.agent_id',$validated) ? 'is-valid' : '' }}" wire:model.lazy="info.agent_id" aria-label="Default select example"  >
