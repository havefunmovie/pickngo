    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-5 align-self-center">
                <h4 class="page-title">Create Pickup & Delivery Service</h4>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="page-title">Create Pickup & Delivery Service Prices</h4>
                            ...
                            <form wire:submit.prevent="create" class="needs-validation bt-switch">
                                ...
                                <div class="row mt-1">
                                    <div class="col-md-12 pt-4">
                                        <button type="submit" class="btn btn-success btn-md float-right"><span class="mdi mdi-plus"></span> {{ __('Add') }}</button>
                                    </div>
                                </div>
                            </form>    
                        </div>
