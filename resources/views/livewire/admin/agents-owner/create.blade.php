    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-5 align-self-center">
                <h4 class="page-title">Create Agent Owner</h4>
                <div class="d-flex align-items-center">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="">Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="">Agent Owner</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Create Agent Owner</li>
                        </ol>
                    </nav>
                </div>
            </div>
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" wire:model.lazy="info.tps" class="form-control {{ $errors->has('info.tps') ? 'is-invalid' : '' }} {{ $validated && array_key_exists('info.tps',$validated) ? 'is-valid' : '' }}" id="tps">
                                            @error('info.tps') <span class="text-danger">{{ $message }}</span> @enderror
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="tvq">TVQ/TVP :</label>
                                            <input type="text" wire:model.lazy="info.tvq" class="form-control {{ $errors->has('info.tvq') ? 'is-invalid' : '' }} {{ $validated && array_key_exists('info.tvq',$validated) ? 'is-valid' : '' }}" id="tvq">
                                            @error('info.tvq') <span class="text-danger">{{ $message }}</span> @enderror
                                        </div>
                                    </div>
                                </div>
                                <div class="row mt-1">
