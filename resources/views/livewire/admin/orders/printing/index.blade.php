                        ...
                        <div class="col-md-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <label for="example-text-input" class="col-md-3 col-xs-4 col-form-label">{{ __("Paper Type") }}:</label>
                                        <div class="col-md-9 col-xs-6">
                                    ...
                                    <div class="form-group row">
                                        <label for="example-text-input" class="col-md-3 col-xs-4 col-form-label">{{ __("Color Type") }}:</label>
                                        <div class="col-md-9 col-xs-6">
                                            <label class="mt-2" id="color_type"></label>
                                        </div>
                                    </div>
                                    <div class="form-group row">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-6">
                                <h4 class="page-title">Printing List (User)</h4>
                                <h6 class="card-subtitle"></h6>
                            </div>
                        </div>
                        <div class="table-responsive mt-3">
                            <livewire:admin.orders.printing.printing-datatable />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-6">
                                <h4 class="page-title">Printing List (Agent)</h4>
                                <h6 class="card-subtitle"></h6>
                            </div>
                        </div>
                        <div class="table-responsive mt-3">
                            <livewire:admin.orders.printing.printing-agent-datatable />
                        </div>
                    </div>
                </div>
            </div>
    ...
    <x-slot name="script">
        <script>
            window.addEventListener('printing-detail', event => {
                ...
                $('#color_type').text(event.detail.color_type);
