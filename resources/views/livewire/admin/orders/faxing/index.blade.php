    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-5 align-self-center">
                <h4 class="page-title">Faxing Orders</h4>
                <div class="d-flex align-items-center">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="">Dashboard</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Faxing Orders</li>
                        </ol>
                    </nav>
                </div>
            </div>
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <label for="example-text-input" class="col-md-3 col-xs-4 col-form-label">{{ __("Send To") }}:</label>
                                        <div class="col-md-9 col-xs-6">
                                            <label class="mt-2" id="SendToNumber"></label>
                                        </div>
                                    </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-6">
                                <h4 class="page-title">Faxing List</h4>
                                <h6 class="card-subtitle"></h6>
                            </div>
                        </div>
                        <div class="table-responsive mt-3">
                            <livewire:admin.orders.faxing.faxing-datatable />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="table-responsive mt-3">
                            <livewire:admin.orders.faxing.faxing-agent-datatable />
                        </div>
                    </div>
                </div>
            </div>
    ...
    <x-slot name="script">
        <script>
            window.addEventListener('faxing-detail', event => {
                ...
                $('#SendToNumber').text(event.detail.phone);
