        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    <button class="btn btn-success m-1 mx-md-5" wire:click="OrderReady({{ $FaxingId }})"">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <a href="{{ route('agent.faxing.selectUser') }}" class="btn btn-outline-info float-right"><i class="mdi mdi-plus"></i> Add New Printing</a>
                            </div>
                        </div>
                        <div class="table-responsive mt-3">
                            <livewire:admin.agent.faxing.faxing-datatable />
                        </div>
                    </div>
                </div>
            </div>
