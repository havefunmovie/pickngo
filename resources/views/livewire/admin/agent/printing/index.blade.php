    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-5 align-self-center">
                <h4 class="page-title">Printing Orders</h4>
                <div class="d-flex align-items-center">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="">Dashboard</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Printing Orders</li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <label for="example-text-input" class="col-md-3 col-xs-4 col-form-label">{{ __("Paper Size") }}:</label>
                                <div class="col-md-9 col-xs-6">
                                    <label class="mt-2" id="paper_type"></label>
                                </div>
                            </div>

                            <div class="form-group row">
                                <label for="example-text-input" class="col-md-3 col-xs-4 col-form-label">{{ __("Color") }}:</label>
                                <div class="col-md-9 col-xs-6">
                                    <label class="mt-2" id="color"></label>
                                </div>
                            </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    <button class="btn btn-success m-1 mx-md-5" wire:click="OrderReady({{ $PrintingId }})"">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-6">
                                <h4 class="page-title">Printing List</h4>
                                <h6 class="card-subtitle"></h6>
                            </div>
                            <div class="col-sm-6">
                                <a href="{{ route('agent.printing.selectUser') }}" class="btn btn-outline-info float-right"><i class="mdi mdi-plus"></i> Add New Printing</a>
                            </div>
                        </div>
                        <div class="table-responsive mt-3">
                            <livewire:admin.agent.printing.printing-datatable />
                        </div>
                    </div>
                </div>
            </div>
    ...
    <x-slot name="script">
        <script>
            window.addEventListener('printing-detail', event => {
                ...
                $('#paper_type').text(event.detail.paper_type);
                $('#paper_count').text(event.detail.paper_count);
                $('#color').text(event.detail.color_type);
