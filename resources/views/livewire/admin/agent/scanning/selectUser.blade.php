    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-5 align-self-center">
                <h4 class="page-title">{{ __('Create New Scanning') }}</h4>
                <div class="d-flex align-items-center">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="">Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="">Scannings</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Create New Scanning</li>
                        </ol>
                    </nav>
                </div>
            </div>
                    ...
                    <div class="card-body wizard-content">
                        <div class="row">
                            ...
                            <div class="col-md-3 text-center">
                                <button wire:click="createScanningForNewUser()" class="btn btn-outline-primary">Create Scanning for new user</button>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <livewire:admin.agent.scanning.users-datatable />
                                    </div>
                                </div>
                            </div>
                        </div>
