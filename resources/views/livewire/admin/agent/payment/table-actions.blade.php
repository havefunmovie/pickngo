<div class="flex space-x-1 justify-around">
    <a wire:click="showByMe({{ $id }})" target="_blank" class="p-1 text-teal-600 hover:bg-teal-600 hover:text-white rounded">
    ...
    <a href="{{ route('agent.payment.edit', [$id]) }}" class="p-1 text-blue-600 hover:bg-blue-600 hover:text-white rounded">
