    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-5 align-self-center">
                <h4 class="page-title">{{ __('Create New Envelop') }}</h4>
                <div class="d-flex align-items-center">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="">Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="">Envelops</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Create New Envelop</li>
                        </ol>
                    </nav>
                </div>
            </div>
                    ...
                    <div class="card-body wizard-content">
                        <div class="tab-wizard wizard-circle">
                            ...
                            <div class="row setup-content {{ $currentStep != 1 ? 'displayNone' : '' }}" id="step-1">
                                <div class="col-12">
                                    <livewire:admin.agent.envelop.details.shipping :services='$services'/>
                                </div>
                            </div>
                            <div class="row setup-content {{ $currentStep != 2 ? 'displayNone' : '' }}" id="step-2">
                                <div class="col-12">
                                    <livewire:admin.agent.envelop.details.get-quote />
                                </div>
                            </div>
                            <div class="row setup-content {{ $currentStep != 3 ? 'displayNone' : '' }}" id="step-3">
                                <div class="col-12">
                                    <livewire:admin.agent.envelop.details.get-label />
                                </div>
                            </div>
                        </div>
                    </div>
