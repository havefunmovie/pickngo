                    ...
                    <div class="card-body wizard-content">
                        <div class="row">
                            ...
                            <div class="col-md-3 text-center">
                                <button wire:click="createEnvelopForNewUser()" class="btn btn-outline-primary">Create Envelop for new user</button>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <livewire:admin.agent.envelop.users-datatable />
                                    </div>
                                </div>
                            </div>
                        </div>
