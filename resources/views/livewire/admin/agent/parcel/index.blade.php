<div>
    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-5 align-self-center">
                <h4 class="page-title">Parcel Orders</h4>
                <div class="d-flex align-items-center">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="">Dashboard</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Parcel Orders</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <!-- Parcel info Model -->
    <div id="parcel-info" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-keyboard="false" data-backdrop="static">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-6">
                                <h4 class="page-title">Parcel List</h4>
                                <h6 class="card-subtitle"></h6>
                            </div>
                            <div class="col-sm-6">
                                <a type="button" href="{{ route('agent.parcel.selectUser') }}" class="btn btn-outline-info float-right"><i class="mdi mdi-plus"></i> Add New Parcel</a>
                            </div>
                        </div>
                        @if($error)
                        ...
                        <div class="table-responsive mt-3">
                            <livewire:admin.agent.parcel.parcel-datatable />
                        </div>
                    </div>
                </div>
            </div>
