        ...
        @if($data)
            @foreach($data['services'] as $row)
                <tr>
                    ...
                    <td align="center" valign="center">{{$row['tot_charge']}}</td>
...
{{--                    <td align="center" valign="center" class="fw-bolder text-primary">{{$row['negotiated_charge']}}</td>--}}
                    <td align="center" valign="center">
                        <button wire:click="selectService('{{ $row['service_code'] }}')" class="btn btn-sm btn-outline-success py-0">Select</button>
                    </td>
                </tr>
            @endforeach
        @endif
        ...
        <div class="row">
            <div class="col-md-6">
                <p class="text-uppercase font-weight-bold">
                    Price : {{ $desired_object['tot_charge'] }}
                </p>
                <p class="text-uppercase font-weight-bold">
                    Tax : ${{ $total_price - ltrim($this->desired_object['tot_charge'], '$') }}
                </p>
                <p class="text-uppercase font-weight-bold">
                    Total : ${{ $total_price }}
                </p>
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        ...
                        <button wire:click="payedBy('Visa')" style="background: none !important; border: none;"  class="py-0 mx-2">
                        ...
                        <button wire:click="payedBy('Mastercard')" style="background: none !important; border: none;"  class="py-0 mx-2">
                        ...
                        <button wire:click="payedBy('American Express')" style="background: none !important; border: none;"  class="py-0 mx-2">
                        ...
                        <button wire:click="payedBy('Debit')" style="background: none !important; border: none;"  class="py-0 mx-2">
                        ...
                        <button wire:click="payedBy('cash')" style="background: none !important; border: none;"  class="py-0 mx-2">
    ...
    <div class="row">
        <div class="col-sm-6">
            <button wire:click="prev" class="btn btn-outline-info float-left"><i class="mdi mdi-arrow-left-bold"></i> {{ __('Previous') }}</button>
        </div>
        @if ($total_price )
            <div class="col-md-6">
                <div id="showCash" class="card">
                    <div class="card-header">
                    <b> Calculate return cash </b>
                            <input wire:model="paidAmount" class="form-control mt-4" type="text" placeholder="insert customer paied amount">
                            <p class="p-2">return amount : <b>{{ $returnAmount }}</b> </p>
                        <button class="float-right btn btn-outline-info" wire:click="calculate()">Calculate</button>
                    </div>
                </div>
            </div>
        @endif
