                ...
                <div class="card mt-5">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="exampleInputPassword1">{{ __('Lastname') }}</label>
                                    <input type="text" class="form-control" name="family" value={{ auth()->user()->family }}>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="exampleInputPassword1">{{ __('Username') }}</label>
                        ...
                        <div class="row mt-md-3">
                            <div class="col-md-1">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">{{ __('Unit No') }}</label>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="exampleInputPassword1">{{ __('Province') }}</label>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label for="exampleInputPassword1">{{ __('Postal code') }}</label>
