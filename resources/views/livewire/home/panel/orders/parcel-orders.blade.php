...
{{--                        <div class="swiper-slide shadow rounded py-3 text-center active">--}}
...
{{--                            </svg>--}}
{{--                            <h3 class="fs-7 mt-2 mb-0 fw-light">{{ __('Orders') }}</h3>--}}
{{--                        </div>--}}
{{--                    </div>--}}
{{--                </div>--}}
{{--            </div>--}}
            ...
            <div class="kinds mb-3">
                <div class="swiper-container mySwiper py-4">
                    <div class="swiper-wrapper">
                        <div wire:click="redirectTohome('parcel')" class="swiper-slide shadow rounded py-3 text-center {{--{{ $param == 'parcel-orders' ? 'active' : '' }}--}}">
                            <svg class="mx-auto" width="40" enable-background="new 0 0 512 512" height="50" viewBox="0 0 52 50">
                                <path d="M0 18.75H20.625V33.3333H30.9375V18.75H51.5625V50H0V18.75ZM20.625 16.6667H0L10.3125 0H22.6875L20.625 16.6667ZM30.9375 16.6667H51.5625L41.25 0H28.875L30.9375 16.6667ZM22.6875 16.6667H28.875L26.8125 0H24.75L22.6875 16.6667ZM22.6875 18.75V31.25H28.875V18.75H22.6875ZM4.125 35.4167V37.5H18.5625V35.4167H4.125ZM4.125 43.75V45.8333H18.5625V43.75H4.125ZM4.125 39.5833V41.6667H14.4375V39.5833H4.125Z"/>
                            </svg>
...
{{--                            @switch($param)--}}
{{--                                @case('parcel-orders')--}}
                            <h5>{{ __('Parcel History') }}</h5>
                                <livewire:home.panel.orders.parcel-orders.parcel />
{{--                                @break--}}
{{--                                @case('envelop-orders')--}}
                            <h5 class="mt-4">{{ __('Envelop History') }}</h5>
                                <livewire:home.panel.orders.envelop-orders.envelop />
{{--                                @break--}}
{{--                                @case('scanning-orders')--}}
                            <h5 class="mt-4">{{ __('Scanning History') }}</h5>
                                <livewire:home.panel.orders.scanning-orders.scanning />
{{--                                @break--}}
{{--                                @case('printing-orders')--}}
                            <h5 class="mt-4">{{ __('Printing History') }}</h5>
                                <livewire:home.panel.orders.printing-orders.printing />
{{--                                @break--}}
{{--                                @case('faxing-orders')--}}
                            <h5 class="mt-4">{{ __('Faxing History') }}</h5>
                                <livewire:home.panel.orders.faxing-orders.faxing />
{{--                                @break--}}
{{--                                @case('pickup-delivery')--}}
{{--                                @break--}}
{{--                                @case('mailbox-orders')--}}
                            <h5 class="mt-4">{{ __('Mailbox History') }}</h5>
                                <livewire:home.panel.orders.mailbox-orders.mailbox />
{{--                                @break--}}
{{--                            @endswitch--}}
                        </div>
                    </div>
