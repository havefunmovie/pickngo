...
{{--                                        <td><strike> {{$mServiceSummary['tot_charge']}} </strike></td>--}}
                                        <td>{{$mServiceSummary['currency']}}</td>
                                        <td>{{'$'.$package['tax']}}</td>
                                        <td class="fw-bolder text-primary">{{$final_payable = $mServiceSummary['negotiated_charge']}}</td>
                                    </tr>
{{--                                @endforeach--}}
                            @endif
                        </table>
...
{{--                                    <td class="text-secondary">{{ $package['length'] . 'x' . $package['width'] . 'x' . $package['height'] . ' (' . $package['type'] . ')' }}</td>--}}
        ...
        <div class="accordion-item border-0 px-3 py-2 mt-3 shadow-none">
            ...
            <div class="accordion-collapse show" >
                <livewire:home.panel.services.envelop-content.envelop.payment />
            </div>
        </div>
    </div>
</div>
