                ...
                <div class="col-md-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <p class="text-secondary">
                                @isset($data)
                                    {{ $data['paper']['paper_color'] }}
                                @endisset
                            </p>
                        </div>
                        <div class="col">
                            <h6>{{ __('Paper Count') }}</h6>
                            <p class="text-secondary">
                                @isset($data)
                                    {{ $data['paper']['paper_num'] }}
                                @endisset
                            </p>
                        </div>
                        <div class="col">
        ...
        <div class="accordion-item border-0 px-3 py-2 mt-3 shadow-none">
            <div class="accordion-header d-flex align-items-center py-2">
                <div class="d-flex btn btn-pink rounded-pill px-4 fs-8 show" >
                    <span class="me-2">@isset($data) {{ __('Amount Payable $').$data['paper']['price'] }} @endisset</span>
                </div>
            </div>
            <div class="accordion-collapse show" >
                <livewire:home.panel.services.printing-content.printing.payment />
            </div>
        </div>
    </div>
</div>
