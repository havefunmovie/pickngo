<div>
    ...
    <ul class="StepProgress">
        <li class="StepProgress-item current {{ $current == '' ? '' : 'is-done' }}">
            <strong class="ps-3">{{ __('Printing Details') }}</strong>
            @if($current == '')
                <livewire:home.panel.services.printing-content.printing.services-upload :services='$services'/>
            @endif
        </li>
        <li class="StepProgress-item current {{ $current == '2' || $current == '3' ? 'is-done' : '' }}">
            ...
            <div class="{{ $current == '1' ? '' : 'collapse' }}">
                <livewire:home.panel.services.printing-content.printing.services-review-payment />
            </div>
        </li>
        <li class="StepProgress-item current {{ $current == '3' ? 'is-done' : '' }}">
            ...
            <div class="{{ $current == '2' || $current == '3' ? '' : 'collapse' }}">
                <livewire:home.panel.services.printing-content.printing.services-get-label :data="$data"/>
            </div>
        </li>
    </ul>
</div>