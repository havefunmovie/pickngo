<div>
    <div class="services-page mt-2">
            ...
            <div class="container">
                <div class="head pt-3">
                    <h2 class="fs-3">{{ __('Services') }}</h2>
                </div>

                <div class="kinds mb-3">
                    <div class="swiper-container mySwiper py-4">
                        <div class="swiper-wrapper">
                            <div wire:click="redirectTohome('parcel')" class="swiper-slide shadow rounded py-3 text-center {{ $param == 'parcel' ? 'active' : '' }}">
                            ...
                            <div wire:click="redirectTohome('envelop')" class="swiper-slide shadow rounded py-3 text-center {{ $param == 'envelop' ? 'active' : '' }}">
                            ...
                            <div wire:click="redirectTohome('scanning')" class="swiper-slide shadow rounded py-3 text-center {{ $param == 'scanning' ? 'active' : '' }}">
                            ...
                            <div wire:click="redirectTohome('printing')" class="swiper-slide shadow rounded py-3 text-center {{ $param == 'printing' ? 'active' : '' }}">
                            ...
                            <div wire:click="redirectTohome('faxing')" class="swiper-slide shadow rounded py-3 text-center {{ $param == 'faxing' ? 'active' : '' }}">
                            ...
                            <div wire:click="redirectTohome('pickup-delivery')" class="swiper-slide shadow rounded py-3 text-center {{ $param == 'pickup-delivery' ? 'active' : '' }}">
                            ...
                            <div wire:click="redirectTohome('mailbox')" class="swiper-slide shadow rounded py-3 text-center {{ $param == 'mailbox' ? 'active' : '' }}">
                        ...
                        <div class="yellow-circle">
                            <div class="wrapper">
                                <div>
                                    @switch($param)
                                        @case('parcel')
                                            <livewire:home.panel.services.parcel-content.content :services='$services' :token='$paymentToken'/>
                                        @break
                                        @case('envelop')
                                            <livewire:home.panel.services.envelop-content.content :services='$services' :token='$paymentToken'/>
                                        @break
                                        @case('scanning')
                                            <livewire:home.panel.services.scanning-content.content :services='$services' :token='$paymentToken'/>
                                        @break
                                        @case('printing')
                                            <livewire:home.panel.services.printing-content.content :services='$services' :token='$paymentToken'/>
                                        @break
                                        @case('faxing')
                                            <livewire:home.panel.services.faxing-content.content :services='$services' :token='$paymentToken'/>
                                        @break
                                        @case('pickup-delivery')
                                            <livewire:home.panel.services.pickup-content.content :services='$services' :token='$paymentToken'/>
                                        @break
                                        @case('mailbox')
                                            <livewire:home.panel.services.mailbox-content.content :services='$services' :token='$paymentToken'/>
                                        @break
                                    @endswitch
                                </div>
                            </div>
