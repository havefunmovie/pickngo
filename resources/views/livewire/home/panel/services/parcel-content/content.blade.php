...
{{--    @endif--}}
    <ul class="StepProgress">
        <li class="StepProgress-item current {{ $current == '' ? '' : 'is-done' }}">
            ...
            @if($current == '')
                <livewire:home.panel.services.parcel-content.parcel.services-details :services='$services' :apiKey='$api_key'/>
            @endif
        </li>
        <li class="StepProgress-item current {{ $current == '2' || $current == '3' || $current == '4' ? 'is-done' : '' }}">
            ...
            <div class="{{ $current == '1' ? '' : 'collapse' }}">
                <livewire:home.panel.services.parcel-content.parcel.services-get-quote />
            </div>
        </li>
        <li class="StepProgress-item current {{ $current == '3' || $current == '4' ? 'is-done' : '' }}">
            ...
            <div class="{{ $current == '2' ? '' : 'collapse' }}">
                <livewire:home.panel.services.parcel-content.parcel.services-review-payment />
            </div>
        </li>
        <li class="StepProgress-item current  {{ $current == '4' ? 'is-done' : '' }}">
            ...
            <div class="{{ $current == '3' || $current == '4' ? '' : 'collapse' }}">
                <livewire:home.panel.services.parcel-content.parcel.services-get-label :data="$data" :apiKey='$api_key'/>
            </div>
        </li>
    </ul>
</div>
