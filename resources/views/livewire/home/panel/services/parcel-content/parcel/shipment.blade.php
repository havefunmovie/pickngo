...
<div class="row">
    <div style="margin-top: -35px">
        ...
        <span style="margin-left: 5px;">
            <img src="images/home/logo-bg.png" width="130"}}"/>
        </span>
        <span style="margin-left: 5px;">
    ...
    <span style="float: right; margin-right: 10px; font-size: large; color: red;">
        {{ __('Parcel Shipping Order MM') }}
        <input class="inp-non-border" value="{{ $tracking_code_1 }}" type="text">
    </span>
    ...
    <table style="border: 1px solid #000; border-collapse: collapse; width: 100%; margin-top: 1px;" class="tbl-text-size">
        <tr>
            ...
            <td style="border: 1px solid #000; text-align: center; vertical-align: middle;">
                <span>
                    <span>{{ substr($name_from,0,1) }}</span>
                </span>
                <strong>
    ...
    <table style="border-collapse: collapse; width: 100%; margin: 1px 1px 0px;" class="tbl-text-size">
        ...
        <tr>
            ...
            <td width="40%" style="border: 1px solid #000; text-align: center; vertical-align: middle;">
                <span class="inp-non-border" style="width: 100%; height: 20px;">{{ $desc_of_content }}</span>
            </td>
            <td width="15%" style="border: 1px solid #000; text-align: center; vertical-align: middle;">
                <span class="inp-non-border" style="width: 20px;">{{ $country_from }}</span>
            </td>
            <td width="10%" style="border: 1px solid #000; text-align: center; vertical-align: middle;">
                <span class="inp-non-border" style="width: 20px;">{{ '$'.$value_of_content }}</span>
            </td>
            <td width="10%" style="border: 1px solid #000; text-align: center; vertical-align: middle;">
                <span class="inp-non-border" style="width: 20px;">{{ '$'.$value_of_content }}</span>
            </td>
        ...
        <tfoot>
            <tr>
                ...
                <th style="text-align: left; vertical-align: middle;" colspan="2">
                    <input class="inp-non-border" value="{{ '$'.$value_of_content }}" type="text">
                </th>
            </tr>
        </tfoot>
    </table>
        ...
        <tr>
            <td style="border: 1px solid #000;" width="25%">
                ...
                <div style="margin-top: 5px;">
                    @if ($breakable == 'yes')
                        <span style="margin-right: 15px; margin-top: 5px"><img style="margin-top: 1px;" src="{{ public_path('images/home/check.png') }}" width="12px" height="12px" />{{ __(' Yes ') }}</span>
                    ...
                    @else
                        ...
                        <span style="margin-top: 5px"><img style="margin-top: 1px;" src="{{ public_path('images/home/check.png') }}" width="12px" height="12px" />{{ __(' No ') }}</span>
                    @endif
                </div>
            </td>
            <td style="border: 1px solid #000;" width="25%">
            ...
            <td rowspan="2" style="border: 1px solid #000;">
                ...
                <div style="margin-top: 10px">
                    <span>{{ __('$ ') }}<input type="text" class="inp-underline" value="{{ round($tot_price,2) ?? '' }}" style="width: 65px; border:none;text-align: center; border-bottom: 1px solid #000; outline: none;padding: 0px;margin: 0px;font-weight: bold;">{{ __(' (Availabel in whole units of $100)') }}</span>
                </div>
                <div style="margin-top: 10px; margin-left: 60px;">
                    <span><input type="text" class="inp-underline" style="width: 65px; border:none;text-align: center; border-bottom: 1px solid #000; outline: none;padding: 0px;margin: 0px;font-weight: bold;" value="{{ substr($name_from,0,1) }}"><strong>{{ __(" (Customer's initials)") }}</strong></span>
                </div>
            </td>
        </tr>
        <tr>
            <td style="border: 1px solid #000;">
                ...
                <div style="margin-top: 5px">
                    @if ($trans_type_to == 'Residential')
                        <span style="margin-right: 15px; margin-top: 5px"><img style="margin-top: 1px;" src="{{ public_path('images/home/check.png') }}" width="12px" height="12px" />{{ __(' Residential ') }}</span>
                        <span style="margin-top: 5px"><img style="margin-top: 1px;" src="{{ public_path('images/home/uncheck.png') }}" width="12px" height="12px" />{{ __(' Commercial ') }}</span>
                    @else
                        <span style="margin-right: 15px; margin-top: 5px"><img style="margin-top: 1px;" src="{{ public_path('images/home/uncheck.png') }}" width="12px" height="12px" />{{ __(' Residential ') }}</span>
                        <span style="margin-top: 5px"><img style="margin-top: 1px;" src="{{ public_path('images/home/check.png') }}" width="12px" height="12px" />{{ __(' Commercial ') }}</span>
                    @endif
                </div>
            </td>
            <td style="border: 1px solid #000;">
        ...
        <tr>
            ...
            <td style="border: 1px solid #000; padding-top: 4px;">
                ...
                <div style="margin-top: 15px;">
                    {{ __('Per-Pack Waiver') }}
                    <span style="margin-left: 50px;"><input value={{ substr($name_from,0,1) }} type="text" class="inp-underline" style="width: 70px; border:none;text-align: center; border-bottom: 1px solid #000; outline: none;padding: 0px;margin: 0px;font-weight: bold;"></span>
    ...
    <table style="border: 1px solid #000; border-collapse: collapse; width: 100%; margin-top: 1px;" class="tbl-text-size">
        ...
        <tr>
            <td colspan="2" rowspan="2" style="border: 1px solid #000;" width="30%">
                ...
                <div style="margin-top: 5px;">
                    {{ __('L') }}
                    <input type="text" class="inp-underline" value="{{ $length }}" style="width: 25px; border:none;text-align: center; border-bottom: 1px solid #000; outline: none;padding: 0px;margin: 0px;font-weight: bold;">
                    {{ __(' x W') }}
                    <input type="text" class="inp-underline" value="{{ $width }}" style="width: 25px; border:none;text-align: center; border-bottom: 1px solid #000; outline: none;padding: 0px;margin: 0px;font-weight: bold;">
                    {{ __(' x H') }}
                    <input type="text" class="inp-underline" value="{{ $height }}" style="width: 25px; border:none;text-align: center; border-bottom: 1px solid #000; outline: none;padding: 0px;margin: 0px;font-weight: bold;">
                </div>
                <div style="margin-top: 5px;">
            ...
            <td style="border: 1px solid #000;" width="40%">
                ...
                <div style="margin-top: 5px;">
                    ...
                    <span style="margin-top: 5px"><input type="text" class="inp-underline" style="width: 65px; border:none;text-align: center; border-bottom: 1px solid #000; outline: none;padding: 0px;margin: 0px;font-weight: bold;"></span>
                </div>
            </td>
            ...
            <td style="border: 1px solid #000;" width="10%">
                <input type="text" class="inp-underline" {{-- value="{{ '$'.(round($price ,2) ?? '0') }}" --}} style="width: 65px; border:none;text-align: center; border-bottom: 1px solid #000; outline: none;padding: 0px;margin: 0px;font-weight: bold;">
            </td>
        </tr>
        <tr>
            <td style="border: 1px solid #000; text-align: left; vertical-align: top;" height="30px;">
                ...
                <div>
                    <span><input type="text" value="{{ $tracking_code }}" class="inp-underline" style="width: 200px; border:none;text-align: center; border-bottom: 1px solid #000; outline: none;padding: 0px;margin: 0px;font-weight: bold;"></span>
                </div>
            </td>
            <td style="border: 1px solid #000;">
        ...
        <tr>
            <td style="border: 1px solid #000;">
                {{ __('Actual Weight') }}
                <br>
                <input type="text" class="inp-underline" value="{{ $weight }}" style="width: 60px; border:none;text-align: center; border-bottom: 1px solid #000; outline: none;padding: 0px;margin: 0px;font-weight: bold;">
                {{ __(' Lbs') }}
            </td>
            <td style="border: 1px solid #000;">
                {{ __('Dimensional Weight') }}
                <br>
                <input type="text" class="inp-underline" style="width: 60px; border:none;text-align: center; border-bottom: 1px solid #000; outline: none;padding: 0px;margin: 0px;font-weight: bold;">
                {{ __(' Lbs') }}
            </td>
            <td style="border: 1px solid #000;">
                {{ __('Carrier') }}
                <div style="margin-top: 5px;">
                    <span style="margin-right: 15px; margin-top: 5px"><img style="margin-top: 1px;" src="{{ public_path('images/home/check.png') }}" width="12px" height="12px" />{{ __(' UPS ') }}</span>
                    ...
                    <span style="margin-top: 5px"><input type="text" class="inp-underline" style="width: 100px; border:none;text-align: center; border-bottom: 1px solid #000; outline: none;padding: 0px;margin: 0px;font-weight: bold;"></span>
                </div>
            </td>
            <td style="border: 1px solid #000;">
                <div style="margin-top: 0px;">
        ...
        <tr>
            <td rowspan="4" colspan="3" style="border: 1px solid #000;">
                ...
                <table>
                    ...
                    <tr>
                        <td><input type="text" class="inp-underline" value="{{ auth()->user()->name }}" style="width: 100px; border:none;text-align: center; border-bottom: 1px solid #000; outline: none;padding: 0px;margin: 0px;font-weight: bold;"></td>
                        <td><input type="text" class="inp-underline" value="{{ date('d/m/Y') }}" style="width: 100px; border:none;text-align: center; border-bottom: 1px solid #000; outline: none;padding: 0px;margin: 0px;font-weight: bold;"></td>
                    </tr>
                </table>
            </td>
            <td style="border: 1px solid #000;">
        ...
        <tr>
            ...
            <td style="border: 1px solid #000;">
                <input type="text" class="inp-underline" value="{{'$'.$tax }}" style="width: 65px; border:none;text-align: center; border-bottom: 1px solid #000; outline: none;padding: 0px;margin: 0px;font-weight: bold;">
            </td>
        </tr>
        <tr>
            <td style="border: 1px solid #000;">
            ...
            <td style="border: 1px solid #000;">
                <input type="text" class="inp-underline" value="{{ '$'.($tot_price ?? '0') }}" style="width: 65px; border:none;text-align: center; border-bottom: 1px solid #000; outline: none;padding: 0px;margin: 0px;font-weight: bold;">
            </td>
        </tr>
    </table>
