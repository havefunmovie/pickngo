    ...
    <form wire:submit.prevent="saveFrom" class="needs-validation">
        <div class="accordion-body px-0 row">
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="text" wire:model="from.attention" class="form-control {{ $errors->has('from.attention') ? 'is-invalid' : '' }} {{ $validated && array_key_exists('from.attention',$validated) ? 'is-valid' : '' }}  fw-lighter fs-8" id="attention" placeholder="{{__('Attention / Person')}}">
