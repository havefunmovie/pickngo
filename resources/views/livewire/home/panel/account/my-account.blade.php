                ...
                <div class="col-md-9">
                    <div class="wrapper">
                        <div>
                            @switch($param)
                                @case('my-account')
                                    <livewire:home.panel.account.my-account.account-details />
                                @break
                                @case('payment-methods')
                                    <livewire:home.panel.account.my-account.payment-methods />
                                @break
                                @case('address-book')
                                    <livewire:home.panel.account.my-account.address-book />
                                @break
                                @case('edit-address')
                                    <livewire:home.panel.account.my-account.edit-address />
                                @break
                                @case('transactions')
                                    <livewire:home.panel.account.my-account.transactions />
                                @break
                                @case('create')
                                <livewire:home.panel.account.my-account.create />
                                @break
                                @case('account-edit')
                                <livewire:home.panel.account.my-account.account-edit />
                                @break
                                @case('create-address-book')
                                <livewire:home.panel.account.my-account.create-address-book />
                                @break
                                @case('notifications')
                                <livewire:home.panel.account.my-account.notifications />
                                @break
                            @endswitch
                        </div>
                    </div>
