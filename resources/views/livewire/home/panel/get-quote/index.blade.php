            ...
            <div class="kinds mb-3">
                <div class="swiper-container mySwiper py-4">
                    <div class="swiper-wrapper">
                        ...
                        <div wire:click="redirectTohome('pickup-delivery')" class="swiper-slide shadow rounded py-3 text-center {{ $param === '' ? 'active' : '' }}">
                        ...
                        <div wire:click="redirectTohome('mailbox')" class="swiper-slide shadow rounded py-3 text-center {{ $param === '' ? 'active' : '' }}">
                ...
                <div class="col-md-9">
                    <div class="wrapper">
                        <div>
                            @switch($param)
                                @case('parcel')
                                <livewire:home.panel.get-quote.parcel />
                                @break
                                @case('envelop')
                                <livewire:home.panel.get-quote.envelop />
                                @break
                                @case('scanning')
